...
EXCLUDE_PATTERNS = [
    ...
    r"\bimage gallery\b",
    r"\bslideshow\b",
    r"\bpicture special\b",
    r"\bpodcast\b",
    r"\bquiz\b",
    r"\bask me anything\b",
    r"\bplanning committee\b",
    r"\bredevelopment approval\b",
    r"\bstadium redevelopment\b",
    r"\bstadium approval\b",
    r"\bplanning approval\b",
    r"\bfoodbank\b",
    r"\bcollection at sunday'?s match\b",
    r"\bsupport our .*collection\b",
    r"\bcharity\b",
    r"\bcommunity drive\b",
